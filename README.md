...
| 阶段 | 天数 | 状态 |
| --- | --- | --- |
| ① 基础收尾（包 / 依赖 / 标准库 / 正则 / 调试） | Day 15–20 | 🟨 进行中（Day 19 调试：traceback / pdb / logging；剩 Day 20 复习） |
...
| 🚧 | Day 19 | 调试：读 traceback / `print` 打点 / `breakpoint()`+pdb / `logging` 分级 / `assert` | `day19/day19.py` + `crash_demo.py` + `pdb_demo.py` | `day19/homework19.py` — 调试练习台（读错误名 / 修 bug / logging 落盘） |
